...
> **已归档（2026-09-08）**：T0–T4 全部完成，不参与现行排期。现行主线见 [`docs/TODO-MAINLINE.md`](../TODO-MAINLINE.md)。

来源：[2026-09-05-项目完整分析.md](./2026-09-05-项目完整分析.md)（分析基线 `6b5a5cb`，P1–P10 编号出自该报告）。
