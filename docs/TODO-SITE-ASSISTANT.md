...
- [ ] T4.E1 卡口↔小影互导（半小时，零风险）：卡口规则/AI 回答的尾部提示区加一句「也想了解站主或找内容？问小影 →」链到 /ask；小影已引导行动问题去卡口，补齐反向成环
...
- [ ] T4.E3 exchange 厅补苗（内容决策，归用户）：五厅唯一 0 篇的厅；候选=副业蓝图（side-hustle-blueprint，现 hall=showcase 但商业语义更贴 exchange）挪 hall 或新写种子文；只改 frontmatter 一行
