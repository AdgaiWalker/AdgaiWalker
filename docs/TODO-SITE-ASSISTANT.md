...
- [ ] T4.E2 主页入口分级（设计决策，需用户拍板后实施）：主页同屏 7+ 触点已近过载；方案=「小影卡与卡口 CTA 做视觉主次」——主入口放大（候选：小影，常驻对话价值更高）、次要入口缩为文字链；先出静态对比稿让用户选，不直接动代码
...
- [ ] T4.E4 Learn 空架观察（不排期）：学徒/专家 0 篇属内容自然生长欠账，等真实学习路径产出再填；架子与路由已就绪，无工程动作
